                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label for="" class="label">Position</label>
                                     <input type="text" name="position" value="{{ $data->position }}" class="form-control form-control-sm">       
                                </div>
                                <div class="form-group">
                                    <label for="" class="label">Description</label>
                                     <textarea name="desc" class="form-control form-control-sm">{{ $data->position }}</textarea>       
                                    </label>
                                </div>
                            </div>
                        </div>
